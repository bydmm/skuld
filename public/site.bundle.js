...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_socket_io_client__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3__ = __webpack_require__(21);
...
var socket = __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default()('http://localhost:5000');
var chart = {};
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#js-start').click(function(){
  var interval = parseInt(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#js-interval').val());
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#js-graph').html('');
  chart = new Chart(interval);
  var url = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#js-url').val();
  socket.emit('start', {url: url, interval: interval});
});

__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#js-stop').click(function(){
  socket.emit('stop');
});
...
function Chart(interval) {
  ...
  var groups = {
    requestCount: {
      value: 0,
      color: 'blue',
      data: __WEBPACK_IMPORTED_MODULE_2_d3__["range"](limit).map(function() {
        return 0
      })
    },
    successCount: {
  ...
  var x = __WEBPACK_IMPORTED_MODULE_2_d3__["time"].scale()
      .domain([now - (limit - 2), now - duration])
      .range([0, width]);

  var y = __WEBPACK_IMPORTED_MODULE_2_d3__["scale"].linear()
  ...
  var svg = __WEBPACK_IMPORTED_MODULE_2_d3__["select"]('#js-graph').append('svg')
        .attr('class', 'chart')
        .attr('width', width)
  ...
  var axis = svg.append('g')
        ...
        .call(x.axis = __WEBPACK_IMPORTED_MODULE_2_d3__["svg"].axis().scale(x).orient('bottom'))
